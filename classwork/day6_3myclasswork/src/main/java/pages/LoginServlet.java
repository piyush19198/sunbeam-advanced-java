...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//		pw.flush(); //java.lang. IllegalStateException : can't forward after committing the resp
				...
				//includes DYNAMICALLY contents of the next page  : in the SAME request
				rd.include(request, response);
				//WC : suspends the exec of the curnt page, DOES NOT discard PW's buffer , invokes CandidateListPage's 
				//doGet method.
