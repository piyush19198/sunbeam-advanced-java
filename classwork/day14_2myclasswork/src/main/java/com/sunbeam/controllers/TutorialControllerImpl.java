...
public class TutorialControllerImpl {
	...
	*/
	...
	public String manage(Model model) {
		List<Tutorial> list = tutorialService.findAllTutorials();
		model.addAttribute("tutorialList", list);
	...
	@PostMapping("/edit")
	public String update(Tutorial tutorial, Model model) {
		int count = tutorialService.save(tutorial);
		String message = "Tutorials updated: " + count + ".";
